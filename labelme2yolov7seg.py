...
class_list = ["mavic", "phantom", "background"]
...
def train_val_split(labelme_dataset_dir,ouput_dataset_dir,image_name,train_val_ratio=0.2):
    ...
    for i in range (len(train_idxs)):
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".png"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".png", train_image_folder) # move train txt
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".txt"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".txt", train_label_folder) # move train image
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".json"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".json", train_json_folder) # move train json
    for i in range (len(val_idxs)):
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".png"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".png", val_image_folder) # move val txt
            print("a")
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".txt"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".txt", val_label_folder) # move val image
            print("b")
        if path.exists(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".json"):
            shutil.move(labelme_dataset_dir+"/"+f'{os.path.splitext(json_files[i])[0]}'+".json", val_json_folder) # move val json
            print("c")
